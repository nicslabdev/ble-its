    ...
    while (read < size) {
        ...
        switch (type) {
            case HeaderFieldType::Generation_Time: {
                printf("    - HeaderFieldType -> generation time \n");
                Time64 time;
                deserialize(ar, time);
                field = time;
            ...
            case HeaderFieldType::Generation_Time_Confidence: {
                printf("    - HeaderFieldType -> generation time confidence \n");
            ...
            case HeaderFieldType::Expiration: {
                printf("    - HeaderFieldType -> expiration \n");
                Time32 time;
                deserialize(ar, time);
                field = time;
                list.push_back(field);
            ...
            case HeaderFieldType::Generation_Location: {
                printf("    - HeaderFieldType -> generation location \n");
                ThreeDLocation loc;
            ...
            case HeaderFieldType::Request_Unrecognized_Certificate: {
                printf("    - HeaderFieldType -> request unrecognized certificate \n");
            ...
            case HeaderFieldType::Its_Aid: {
                printf("    - HeaderFieldType -> its_aid \n");
                IntX its_aid;
            ...
            case HeaderFieldType::Signer_Info: {
                printf("    - HeaderFieldType -> signer info \n");
                SignerInfo info;
            ...
            case HeaderFieldType::Recipient_Info: {
                printf("    - HeaderFieldType -> recipient info\n");
            ...
            case HeaderFieldType::Encryption_Parameters: {
                printf("    - HeaderFieldType -> encryption parameters \n");
