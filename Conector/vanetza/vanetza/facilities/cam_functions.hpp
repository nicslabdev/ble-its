...
/** MODIFIED
 * Print CAM content with indentation of nested fields - Includes more fields and containers
 * \param os output stream
 * \param cam CA message
 * \param indent indentation marker, by default one tab per level
 * \param start initial level of indentation
 ...
 * from University of Antwerp - erik.debrittoesilva@uantwerpen.be
 */
void print_indented_mod(std::ostream& os, const asn1::Cam& cam, const std::string& indent = "\t", unsigned start = 0);
